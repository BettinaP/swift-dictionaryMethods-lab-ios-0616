...
var starWarsCharacters: [String : [String]] = [ "Heroes" : starWarsHeroes, "Villains" : starWarsVillains, "Droids" : starWarsDroids]
...
var starWarsJedi: [String] = ["Yoda", "Obi-Wan Kenobi", "Mace Windu"]
...
if let starWarsBounty = starWarsCharacters["Bounty Hunters"]{
    print("removed Bouty Hunters")
} else {
